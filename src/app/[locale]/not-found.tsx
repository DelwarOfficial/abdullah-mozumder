...
export default function NotFound({ locale = "en" }: NotFoundProps) {
  const L = {
    ...
    title: locale === "en" ? "This story couldn't be found." : "এই প্রতিবেদনটি পাওয়া যায়নি।",
    desc: locale === "en"
      ? "The page you were looking for may have moved, been renamed, or never existed."
      : "আপনি যে পৃষ্ঠাটি খুঁজছিলেন তা সরিয়ে ফেলা হয়েছে, নাম পরিবর্তন করা হয়েছে, বা কখনো ছিল না।",
