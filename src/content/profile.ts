...
export const profile: Profile = {
  name: L("Abdullah Mozomdar", "আবদুল্লাহ মোজোমদার"),
  ...
  shortBio: L(
    ...
    "আবদুল্লাহ মোজোমদার একজন বাংলাদেশি সাংবাদিক ও সিনিয়র রিপোর্টার। দেশের বেশ কয়েকটি জাতীয় সংবাদপত্রে কাজ করার অভিজ্ঞতা রয়েছে তাঁর।",
  ),
  longBio: L(
